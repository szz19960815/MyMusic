...
(function(z){var a=11;function Z(ops){z.push(ops)}
Z([3,'1827a333'])
Z([3,'_view data-v-7d35ac27 top bgColor'])
Z([3,'_view data-v-7d35ac27 bar'])
Z([[7],[3,'imgSrc']])
Z(z[3])
Z([[2,'!'],[[7],[3,'record']]])
Z([3,'_view data-v-7d35ac27 serch bgDeepColor'])
Z(z[3])
Z([[7],[3,'showSearch']])
...
cs.push("./components/top.vue.wxml:image:1:1213")
cs.pop()
}
var cI=_v()
_(hG,cI)
if(_oz(z,8,e,s,gg)){cI.wxVkey=1
cs.push("./components/top.vue.wxml:view:1:1319")
cs.pop()
}
oH.wxXCkey=1
cI.wxXCkey=1
