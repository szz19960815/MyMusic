...
Z([[7],[3,'imgSrc']])
Z([3,'_image data-v-7d35ac27 icon type'])
Z([[2,'+'],[[7],[3,'imgSrc']],[1,'icon/fenlei.png']])
Z([3,'_view data-v-7d35ac27 barContent'])
Z([3,'handleProxy'])
Z([a,[3,'_view data-v-7d35ac27 '],[[4],[[5],[[2,'?:'],[[7],[3,'record']],[1,'sel'],[1,'']]]]])
Z([[7],[3,'$k']])
Z([1,'1827a333-0'])
Z([3,'录制'])
Z(z[7])
...
Z([3,'排行'])
Z(z[3])
Z([3,'_image data-v-7d35ac27 icon add'])
...
Z([[7],[3,'searchKey']])
Z(z[3])
Z([3,'_image data-v-7d35ac27 icon'])
Z([[2,'+'],[[7],[3,'imgSrc']],[1,'icon/sousuo5.png']])
Z([[7],[3,'showSearch']])
Z([3,'_view data-v-7d35ac27 searchResult'])
Z([3,'index'])
Z([3,'item'])
Z([[6],[[7],[3,'this']],[3,'result']])
Z(z[7])
Z([3,'_view data-v-7d35ac27 resultInfo'])
Z(z[9])
Z([[2,'+'],[1,'1827a333-4-'],[[7],[3,'index']]])
Z([[7],[3,'index']])
...
var fS=_mz(z,'input',['bindconfirm',27,'bindfocus',1,'bindinput',2,'class',3,'confirmType',4,'data-comkey',5,'data-eventid',6,'placeholder',7,'placeholderStyle',8,'type',9,'value',10],[],e,s,gg)
cs.pop()
_(oP,fS)
var xQ=_v()
_(oP,xQ)
...
cs.push("./components/top.vue.wxml:image:1:1213")
var cT=_mz(z,'image',['class',39,'src',1],[],e,s,gg)
cs.pop()
_(xQ,cT)
cs.pop()
}
var oR=_v()
_(oP,oR)
if(_oz(z,41,e,s,gg)){oR.wxVkey=1
...
var oV=_v()
_(hU,oV)
cs.push("./components/top.vue.wxml:view:1:1391")
var cW=function(lY,oX,aZ,gg){
cs.push("./components/top.vue.wxml:view:1:1391")
var e2=_mz(z,'view',['bindtap',46,'class',1,'data-comkey',2,'data-eventid',3,'keys',4],[],lY,oX,gg)
var b3=_oz(z,51,lY,oX,gg)
_(e2,b3)
cs.pop()
_(aZ,e2)
return aZ
}
_wp('./components/top.vue.wxml:view:1:1391: Now you can provide attr `wx:key` for a `wx:for` to improve performance.')
oV.wxXCkey=2
_2z(z,45,cW,e,s,gg,oV,'item','index','')
cs.pop()
cs.pop()
_(oR,hU)
cs.pop()
